# sweph/eventdata.py
# todo detect event 1 or 2 & only calculate once
# ruff: noqa: E402
# import re
import gi
...
class EventData:
    ...
    def __init__(
        ...
        self.old_date_time = ""
        self.old_location = ""
        # separate data : event 1 todo not calculate only once per event
        self.app.e1_sweph = {}
        self.app.e1_chart = {}
        ...
        # single user of gtk4 todo can we move this somewhere else ???
    ...
    def on_datetime_change(self, entry):
        ...
        if datetime_name == "datetime one":
            ...
            # todo calculates in datamanager - so this file need a lot of love
            # hora = get_current_hora(
            #     jd_ut, geo=(lon, lat, alt), objs=(), flag=self.app.sweph_flag
            # )
        ...
        # self.app.e2_active todo
        # _update_main_title(self, change_time, e2_active)
