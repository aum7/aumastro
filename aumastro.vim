...
setlocal statusline=%#lualine_a_10_command#\ ó°€˜\ %#lualine_b_11_command#%#SLGitIcon#\ îœ¥%*%#SLBranchName#\ majorupgrade\ %<%#lualine_c_diff_added_command#\ \ î«œ\ 878\ %#lualine_c_normal#%=%#lualine_x_diagnostics_error_command#\ ï—\ 92\ %#lualine_x_diagnostics_hint_command#î©¡\ 3\ %#lualine_c_normal#%#lualine_c_normal#\ ó°Œ’\ 4\ %#lualine_x_filetype_DevIconPy_command#\ î˜†\ %#lualine_c_normal#python\ %#lualine_b_command#\ \ 22:52\ %#lualine_z_progress_command#\ %P/%L\ 
...
setlocal winbar=\ %#DevIconPy#î˜†%*\ %#Winbar#sidepanesettings.py%*\ 
setlocal winblend=0
