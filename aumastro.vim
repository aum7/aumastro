...
setlocal statusline=%#lualine_a_4_command#\ ó°€˜\ %#lualine_b_5_command#%#SLGitIcon#\ îœ¥%*%#SLBranchName#\ angleruler\ %<%#lualine_c_normal#%=%#lualine_x_diagnostics_error_command#\ ï—\ 2\ %#lualine_x_diagnostics_hint_command#î©¡\ 7\ %#lualine_c_normal#%#lualine_c_normal#\ ó°Œ’\ 4\ %#lualine_x_filetype_DevIconPy_command#\ î˜†\ %#lualine_c_normal#python\ %#lualine_b_command#\ \ \ 5:32\ %#lualine_z_progress_command#\ %P/%L\ 
...
setlocal winbar=\ %#DevIconPy#î˜†%*\ %#Winbar#angleruler.py%*\ 
setlocal winblend=0
